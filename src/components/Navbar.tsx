...
const Navbar = ({setIsMobileSidebarOpen,isMobileSidebarOpen}:Props) => {
  return (
    <header className="h-[60px] z-[999] fixed top-0 font-poppins w-full border-b border-gray-300 shadow-sm text-[#6C7383] bg-white z-3">
      <div className="flex items-center justify-between px-4 h-full w-full mx-auto">
        ...
        <section className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-1 cursor-pointer p-2 rounded-md">
