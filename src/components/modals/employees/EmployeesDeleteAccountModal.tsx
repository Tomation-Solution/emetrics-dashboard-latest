...
interface EmployeesDeleteAccountModalProps {
  handleCloseModal: () => void;
  selectedRowData:object|null
}

const EmployeesDeleteAccountModal = ({handleCloseModal,selectedRowData}: EmployeesDeleteAccountModalProps) => {
    ...
    return (
      ...
      <div className="bg-white rounded-lg  w-full max-w-md  ">
        ...
        <div className="px-7 py-4">
          <p className="text-sm">
            Are you sure you want to permanently remove this member  from the
            society ?
          </p>
          <div className="flex items-center gap-3 mt-5">
            <img src={avatar} className="w-10 h-10 rounded-full" alt="" />
            <div>
              <h3 className="text-base font-medium">Enterprise Media Suite</h3>
...
export default EmployeesDeleteAccountModal