...
interface CompanyActivateSubscriptionModalProps {
...
const CompanyActivateSubscriptionModal = ({handleCloseModal,selectedRowData}:CompanyActivateSubscriptionModalProps) => {
...
export default CompanyActivateSubscriptionModal