...
interface CompanyViewAccountProfileModalProps {
    handleCloseModal: () => void;
    selectedRowData:object|null
  }

const CompanyViewAccountProfileModal = ({handleCloseModal,selectedRowData}:CompanyViewAccountProfileModalProps) => {
    if (selectedRowData){
        return (
...
export default CompanyViewAccountProfileModal