...
const Sidebar = ({isMobileSidebarOpen,setIsMobileSidebarOpen}:Props) => {
  ...
  return (
    ...
    {isMobileSidebarOpen && (
    <div className={`lg:hidden  fixed top-0 w-full h-screen bg-black/70 transition-transform ${isMobileSidebarOpen ? 'translate-x-0 ease-in duration-900' : '-translate-x-full ease-out duration-900'}`} >
