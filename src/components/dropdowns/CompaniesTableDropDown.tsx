...
const CompaniesTableDropDown = ({currentRow,handleOpenModal}:CompaniesTableDropDownProps) => {
  return (
    ...
    <ul className="divide-y" >
      <li>
        <div
         onClick={() => handleOpenModal(currentRow,'activate-subscription-modal')}
          className="menu-item"
      ...
      <li>
        <div
          className="menu-item"
          onClick={() => handleOpenModal(currentRow,'deactivate-subscription-modal')}
        >
      ...
      <li>
        <div
          className="menu-item"
          onClick={() => handleOpenModal(currentRow,'delete-company-account-modal')}
        >
